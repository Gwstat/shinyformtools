...
# --- In-app setup tutorial, shown when MariaDB is not reachable --------------
# This is real app logic (not demo scaffolding): the example shows a tutorial
# instead of crashing when it cannot connect.
